...
dtls=(yellow+"\t\tCreated ʙʏ : Mizanur Rahman Nirob \n \t\thttps://t.me/Unknown_Helper_O02\n \t\thttps://github.com/Cyber-Foxx")
...
mainversion = requests.get("https://raw.githubusercontent.com/Cyber-Foxx/Inbox-killer/main/.version.txt")
...
if(version.read() == mainversion.text):
	...
	os.system("cd .. && rm -rf Inbox-killer && git clone https://github.com/Cyber-Foxx/Inbox-killer > /dev/null 2>&1 && cd Inbox-killer && python Inbox killer.py")
...
print(lightblue+'\t\t If You Type [1] sent it 5 SMS')


print(' ')

number=str(input(red+"[➙] Enter Your Number [Ex: 018********] "))
...
for i in range (amount):
	...
	print(str(i+1)+green+'.	➙Success Requests')
	
print('					')
print(cyan+'\t\tThanks For Using Inbox-killer ')

os.system("xdg-open https://t.me/Unknown_Helper_O02")
